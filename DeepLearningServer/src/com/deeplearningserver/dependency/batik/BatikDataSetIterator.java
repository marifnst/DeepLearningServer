 ...
 * @author Adam Gibson
 */
public class BatikDataSetIterator extends BaseDatasetIterator {
	
	private static final long serialVersionUID = 1L;

	public BatikDataSetIterator(int batch,int numExamples) throws IOException {
     ...
     * @throws IOException
     */
    public BatikDataSetIterator(int batch, int numExamples, boolean binarize) throws IOException {
     ...
     * @throws IOException
     */
    public BatikDataSetIterator(int batchSize, boolean train, int seed) throws IOException{
    	this(batchSize, (train ? BatikDataFetcher.NUM_EXAMPLES : BatikDataFetcher.NUM_EXAMPLES_TEST), false, train, true, seed);
    }
     ...
     */
    public BatikDataSetIterator(int batch, int numExamples, boolean binarize, boolean train, boolean shuffle, long rngSeed) throws IOException {
        super(batch, numExamples,new BatikDataFetcher(binarize,train,shuffle,rngSeed));
    }
